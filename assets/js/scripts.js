(function(){
	...
	// ****** GOOGLE MAP *******
	var map;
	var brooklyn = new google.maps.LatLng(-36.514442,-6.2811,17);
	...
	function initialize() {
		...
		var mapOptions = {
			...
			center: new google.maps.LatLng(36.514442,-6.2811,17),
		...
		var myLatLng = new google.maps.LatLng(36.514442,-6.2811,17);
